...
import image from './Resources/Group 4125 1.jpg'
    ...
    <>
        <div className='flex justify-center w-full'>
            <div className='relative grid'>
                ...
                {/* vector */}
                <svg className='absolute top-[19.81rem] right-0' width="236" height="74" viewBox="0 0 236 74" fill="none" xmlns="http://www.w3.org/2000/svg">
